        ...
        <form name="form-add-school-periods" action="insert.php" method="POST" autocomplete="off" autocapitalize="off">
            <div class="wrap">
                <div class="first">
                    ...
                    <input id="datespstart" class="date" type="text" name="datespstart" value="" pattern="\d{4}-\d{2}-\d{2}" placeholder="YYYY-MM-DD" maxlength="10" required />
                    <label for="datespend" class="label">Termina</label>
                    <input id="datespend" class="date" type="text" name="datespend" value="" pattern="\d{4}-\d{2}-\d{2}" placeholder="YYYY-MM-DD" maxlength="10" required />
                </div>
                <div class="last">
