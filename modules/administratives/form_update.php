        ...
        <form name="form-update-administratives" action="update.php" method="POST">
			<div class="wrap">
				...
				<div class="last">
					...
					<input class="text" type="number" name="txtphone" value="' . $_SESSION['administrative_phone'][0] . '" min="0" max="9999999999" maxlength="10" required/>
...
echo '
					...
					<input class="text" type="text" name="txtemployment" value="' . $_SESSION['administrative_employment'][0] . '" maxlength="100" required/>
