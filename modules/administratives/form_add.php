        ...
        <form name="form-add-administratives" action="insert.php" method="POST">
            <div class="wrap">
                <div class="first">
                    ...
                    <input class="text" style=" display: none;" type="text" name="txtuserid"
                    ...
                    <input class="text" type="text" name="txtcurp" value="" maxlength="18"
                        onkeyup="this.value = this.value.toUpperCase()" required />
                    <label class="label">RFC</label>
                    <input class="text" type="text" name="txtrfc" value="" maxlength="13"
                        onkeyup="this.value = this.value.toUpperCase()" required />
                </div>
                <div class="last">
                    <label class="label">Telefono</label>
                    <input class="text" type="number" name="txtphone" value="" min="0" max="9999999999" maxlength="10" inputmode="email"
                        required />
