		...
		<form name="form-add-groups" action="" method="POST">
			<div class="wrap">
				<div class="first">
					...
					<input class="text" type="text" name="txtgroup" value="<?php if (!empty($_SESSION['id_group'])) {
																				echo $_SESSION['id_group'];
																			} ?>" maxlength="20" autofocus required disabled />
					<label class="label">Nombre</label>
					<input class="text" type="text" name="txtgroupname" value="<?php if (!empty($_SESSION['name_group'])) {
																					echo $_SESSION['name_group'];
																				} ?>" maxlength="100" required disabled />
				</div>
				<div class="last">
					<label class="label">Semestre</label>
					<input class="text" type="number" name="txtgroupsemester" value="<?php if (!empty($_SESSION['semester_group'])) {
																							echo $_SESSION['semester_group'];
