        ...
        <form name="form-add-groups" action="" method="POST">
            <div class="wrap">
                ...
                <div class="last">
                    ...
                    <input class="text" type="number" name="txtgroupsemester" value="<?php echo $_SESSION['semester_group']; ?>" maxlength="2" min="1" max="12" list="defaultsemestres" required />
                    ...
                    <button class="btn-add-subjects" name="btn" value="form_update_subjects" type="submit">Asignaturas</button>
                </div>
            </div>
        </form>
    </div>
